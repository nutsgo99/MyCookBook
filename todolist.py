...
def updating_record():
    if WorkingList.size() > 0:
        ...
        for task in tasks:
            WorkingList.insert("end", "" + task[0] + "=======>>>; Time left: " + str(task[1]) + ".")
...
lbl = tkinter.Label(root, text="Enter Tasks To Do: ", fg="white", bg="blue", font=('Arial', 14), wraplength=200)
lbl_hrs = tkinter.Label(root, text="Enter time (Seconds)", fg="white",  bg="blue", font=('Arial', 14), wraplength=200)
todo = tkinter.Entry(root, width=30, font=('Arial', 14))
time = tkinter.Entry(root, width=15, font=('Arial', 14))
post = tkinter.Button(root, text='Add task', fg="white", bg="green", width=30, command=getting_tasks)
Exit = tkinter.Button(root, text='Exit', fg="white", bg="red", height=3, font=('Arial Bold', 14), relief="ridge", bd=5,
...
WorkingList.place(x=30, y=150, width=395, height=300)
